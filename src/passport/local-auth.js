    ...
    async (req, email, password, done) => {
      ...
      if (!user) {
        return done(
          null,
          false,
          req.flash("loginMessage", "Usuario o contraseña incorrectas")
        );
      }
      ...
      if (!userCaptchaResponse) {
        return done(
          null,
          false,
          req.flash("loginMessage", "Por favor, complete el captcha.")
        );
      }
      ...
      const verificationUrl =
        ...
        "6LeZDuYkAAAAALEHnoXPaTgcxn4ke1cUf6zF7wp9" +
        "&response=" +
        userCaptchaResponse +
        "&remoteip=" +
      ...
      request(verificationUrl, function (error, response, body) {
        ...
        if (body.success !== undefined && !body.success) {
          return done(
            null,
            false,
            req.flash("loginMessage", "El captcha no pudo ser verificado.")
          );
        }
      });
    }
